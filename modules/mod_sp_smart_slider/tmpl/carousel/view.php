                ...
                <div class="container">
                    <div class="row-fluid">
                        ...
                        if( isset($option[ 'image_position' ]) and $option[ 'image_position' ]=='left' ){
                            ...
                            <div class="testimonial-media-wrapper">
                            ...
                            <div class="testimonial-text-wrapper">
                                <div class="slider-content animation <?php echo $content_animation; ?>">
                                    ...
                                    // check title type
                                        ...
                                        {
                                        // add custom title
                                            if( isset($value['customtitle']) and !empty($value['customtitle']) ) echo '<h3 class="sp-smart-title">' . $value['customtitle'] . '</h3>';
                                        } else {
                                        // add title
                                            if( isset($value['title']) and !empty($value['title']) ) echo '<h3 class="sp-smart-title">' . $value['title'] . '</h3>';
                                        }
