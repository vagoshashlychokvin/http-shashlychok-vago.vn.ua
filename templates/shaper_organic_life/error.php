...
<body<?php echo $this->helix->bodyClass('bg clearfix'); ?>>
	<div id="error-page" class="container">
		<div>
			<h2 class="error-code"><?php echo $this->error->getMessage(); ?></h2>
			<p class="error-message"></p><br/>
			<a class="error-button" href="<?php echo $this->baseurl; ?>/index.php" title="<?php echo JText::_('HOME'); ?>">Back To Homepage</a>
		</div>
	</div>
</body>
</html>