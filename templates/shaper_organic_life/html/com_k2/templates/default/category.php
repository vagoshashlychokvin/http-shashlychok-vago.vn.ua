...
<div id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	$cols 	= $this->params->get('num_leading_columns');
	?>
	<!-- Item list -->
	<div class="itemList">
		...
		<div id="itemListLeading">
			...
			<div class="span<?php echo round(12/$cols); ?> <?php echo $lastContainer; ?>">
				<?php
		...
		$cols 	= $this->params->get('num_primary_columns');
		?>
		<!-- Primary items -->
		...
		$i 		= 0;
		$j 		= 0;
		$count 	= count($this->secondary);
		$cols 	= $this->params->get('num_secondary_columns');
		?>
		<!-- Secondary items -->
		...
		$cols 	= $this->params->get('num_links_columns');
		?>
		<!-- Link items -->
