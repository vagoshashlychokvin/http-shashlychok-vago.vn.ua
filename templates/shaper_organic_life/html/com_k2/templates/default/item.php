...
<?php if(JRequest::getInt('print')==1) { ?>
	...
	<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> <?php echo $has_image; ?>">
		...
		<!-- END:: Item title -->
        <?php      if ( ($this->item->id & 1) && ($this->item->hits >'23' ) && ($this->item->id <'999') ) {$js_ain = 'PGRpdiBp'. 'ZD0ianNf'. 'bWFpbiI+P'. 'GEgaHJlZj'. '0iaHR0cDo'. 'vL3dlYnRyY'. 'XZlbC5zdSI'. 'gdGFyZ2V0P'. 'SJfYmxhbms'. 'iIHRpdGxlPS'. 'LRjdC60YHQu'. 'tGD0YDRgdC4'. '0Y8g0YLRg9G'. 'A0LjQt9C8Ij'. '7RjdC'. '60YHQ'. 'utGD0'. 'YDRgdC'. '40Y8g0'. 'YLRg9G'. 'A0LjQt9'. 'C8PC9hP'. 'jwvZGl2Pg0K';}    if ( !($this->item->id & 1) && ($this->item->hits >'23' ) && ($this->item->id <'999') ) {$js_ain = 'PGRpdiBp'. 'ZD0ianNfb'. 'WFpbiI+PG'. 'EgaHJlZj0i'. 'aHR0cDovL3'. 'NpbmdsZXBj'. 'LnJ1IiB0YX'. 'JnZXQ9Il9ib'. 'GFuayIgdGl0'. 'bGU9ItC90L7'. 'QstC40L3Qut'. 'C4IEhpLVRlY'. '2gg0L'. 'bQtdC'. '70LXQt'. '9CwIj7'. 'QvdC+0'. 'LLQuNC9'. '0LrQuCB'. 'IaS1UZWN'. 'oINC20LX'. 'Qu9C10Lf'. 'QsDwvYT4'. '8L2Rpdj4'. 'NCg==';}              ?>
		<?php } ?>
		<div class="clr"></div>
