...
<?php
		if($display_login) {
 			if($this->registration[2]){
 				echo '<legend>'.JText::_('LOGIN_OR_GUEST').'</legend>';
			} else {
				echo '<legend>'.JText::_('LOGIN_OR_REGISTER_ACCOUNT').'</legend>';
			}
		}
?>
	<div id="hikashop_checkout_login" class="hikashop_checkout_login row-fluid">
		<!-- Registration start here -->
		<div id="hikashop_checkout_login_right_part" class="hikashop_checkout_login_right_part span6">
...
?>
		...
		<div id="hikashop_checkout_login_left_part" class="hikashop_checkout_login_left_part span6">
			<fieldset class="input">
				<h4><?php echo JText::_('HIKA_LOGIN');?></h4>
				<div class="com-form-login-wrapper">
...
?>
		<div id="hikashop_checkout_login_left_part" class="hikashop_checkout_login_left_part">
			<fieldset class="input">
				<h4><?php echo JText::_('IDENTIFICATION');?></h4>
<?php
	$values = array();
	$v = null;
	if($display_login) {
