...
<?php if(!$this->simplified_registration){ ?>
	<tr class="hikashop_registration_name_line" id="hikashop_registration_name_line">
		<td class="key">
			...
			<td>
				<input type="text" name="data[register][name]" id="register_name" value="<?php echo $this->escape($this->mainUser->get( 'name' ));?>" class="inputbox required" maxlength="50" /> <span class="hikashop_field_required">*</span>
			</td>
	</tr>
	<tr class="hikashop_registration_username_line" id="hikashop_registration_username_line">
		...
		<td>
			<input type="text" id="register_username" name="data[register][username]" value="<?php echo $this->escape($this->mainUser->get( 'username' ));?>" class="inputbox required validate-username" maxlength="25" /> <span class="hikashop_field_required">*</span>
		</td>
	</tr>
<?php }?>
<tr class="hikashop_registration_email_line">
	...
	<td>
		<input type="text" id="register_email" name="data[register][email]" value="<?php echo $this->escape($this->mainUser->get( 'email' ));?>" class="inputbox required validate-email" maxlength="100" /> <span class="hikashop_field_required">*</span>
	</td>
</tr>
...
<tr class="hikashop_registration_password_line" id="hikashop_registration_password_line">
	...
	<td>
		<input class="inputbox required validate-password" type="password" id="register_password" name="data[register][password]" value="" /> <span class="hikashop_field_required">*</span>
	</td>
</tr>
<tr class="hikashop_registration_password2_line" id="hikashop_registration_password2_line">
	...
	<td>
		<input class="inputbox required validate-passverify" type="password" id="register_password2" name="data[register][password2]" value="" /> <span class="hikashop_field_required">*</span>
	</td>
</tr>
<?php }?>
	<?php
