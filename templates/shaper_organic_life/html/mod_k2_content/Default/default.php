...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul class="itemWrapper">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?> itemList wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="<?php echo $i; ?>ms">
	      ...
	      <div class="itemTextWrapper">
	      	...
	      	<div class="entry-meta wow fadeInUp" data-wow-duration="800ms" data-wow-delay="<?php echo $i+100; ?>ms">
	      		...
	      		<span class="entry-date">
	      			<?php echo JHTML::_('date', $item->created, 'DATE_FORMAT_LC3'); ?>
	      		</span>
	      		<?php } ?>
