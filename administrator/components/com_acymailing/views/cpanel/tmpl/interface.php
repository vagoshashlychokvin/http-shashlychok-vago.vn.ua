...
<?php } ?>
				...
				<label for="config_disqus_shortname" style="<?php if(empty($disqus)) echo "display:none;"; ?>" id="config_disqus_shortname_label">Shortname : </label>
				<input type="text" name="config[disqus_shortname]" id="config_disqus_shortname" value="<?php echo $this->config->get('disqus_shortname'); ?>" size="1" style="width:100px;<?php if(empty($disqus)) echo "display:none;"; ?>" />
<?php if(ACYMAILING_J30) { ?>
				</fieldset></div>
<?php } ?>
			</td>
	...
	<!--
		function updateCommentsOption()
		{
			...
			{
				document.getElementById('config_disqus_shortname_label').style.display = '';
