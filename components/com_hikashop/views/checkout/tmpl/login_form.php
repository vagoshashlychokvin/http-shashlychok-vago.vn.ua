...
?>
	...
	<div id="com-form-login-username" class="ecom-login-input-wrapper">
		<label for="username"><?php echo JText::_('HIKA_USERNAME') ?></label>
		<input name="username" id="username" type="text" class="inputbox" alt="username" size="18" />
	</div>
	<div id="com-form-login-password" class="ecom-login-input-wrapper">
		<label for="passwd"><?php echo JText::_('HIKA_PASSWORD') ?></label>
	...
	?>
	<ul class="com-form-forget-pass-wrapper">
		<li>
