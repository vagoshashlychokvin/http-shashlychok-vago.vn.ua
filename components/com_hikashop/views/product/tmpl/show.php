		...
		<div class="tab">
			<div class="tabbale">
				<ul class="nav nav-tabs" id="tab1">
					...
					<li class="">
						<a href="#tab1-tab2" data-toggle="tab">Specification</a>
					</li>
					<!-- if vote is enable -->
					<?php if($this->params->get('show_vote_product')){ ?>
					<li class="">
						<a href="#tab1-tab3" data-toggle="tab">Reviews</a>
					</li>
					<?php } ?>
				</ul>
				<div class="tab-content">
					...
					<div class="tab-pane fade" id="tab1-tab2">consectetur adipiscing elit. Proin ornare consectetur sodales. Nulla luctus cursus mauris at dapibus. Cras ac felis et neque consequat elementum a eget turpis. Aliquam erat volutpat. Integer feugiat sem eu ligula vulputate consequat. Nulla facilisi. Cras vel elit lectus, at fringilla lorem.</div>
