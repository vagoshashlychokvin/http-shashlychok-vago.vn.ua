	...
	case 'show_default':
		...
		<table>
			<tr>
				...
				<td>
					<div class="quantiy-modify-wrapper">
						<a id="hikashop_product_quantity_field_change_plus_<?php echo $i; ?>" class="hikashop_product_quantity_field_change_plus hikashop_product_quantity_field_change" href="#" onclick="return hikashopQuantityChange('hikashop_product_quantity_field_<?php echo $i; ?>',1,<?php echo $max_quantity; ?>,<?php echo $min_quantity; ?>);"><i style="" class="icon-caret-up quantity-icon"></i></a>

						<a id="hikashop_product_quantity_field_change_minus_<?php echo $i; ?>" class="hikashop_product_quantity_field_change_minus hikashop_product_quantity_field_change" href="#" onclick="return hikashopQuantityChange('hikashop_product_quantity_field_<?php echo $i; ?>',0,<?php echo $max_quantity; ?>,<?php echo $min_quantity; ?>);"><i style="" class="icon-caret-down quantity-icon"></i></a>
					</div>
				</td>
				<td rowspan="2">
					<?php echo $html; ?>
