...
class acymailingSMTP {
	...
	public function Connect($host, $port = 0, $timeout = 30, $options = array()) {
		...
		//Sometimes the stream_socket_client is blocked for security reasons... so we try with a simple fsockopen
	...
	*/
	public function client_send($data) {
		// Greater than 1 strict to avoid too much comment when send is working
			if ($this->do_debug > 1) {
